...
function LanguageProvider(param) {
    ...
    const [currentRegion, setCurrentRegion] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('canada');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            const loadLanguageConfig = {
                "LanguageProvider.useEffect.loadLanguageConfig": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (config.length > 0) {
                                const defaultLang = config.find({
                                    "LanguageProvider.useEffect.loadLanguageConfig": (lang)=>lang.code === 'en'
                                }["LanguageProvider.useEffect.loadLanguageConfig"]) || config[0];
            ...
            }["LanguageProvider.useEffect.loadLanguageConfig"];
            loadLanguageConfig();
        }
    }["LanguageProvider.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            if (savedLanguage && availableLanguages.some({
                "LanguageProvider.useEffect": (lang)=>lang.code === savedLanguage
            }["LanguageProvider.useEffect"])) {
                setCurrentLanguage(savedLanguage);
            }
            if (savedRegion) {
                const currentLangConfig = availableLanguages.find({
                    "LanguageProvider.useEffect.currentLangConfig": (lang)=>lang.code === currentLanguage
                }["LanguageProvider.useEffect.currentLangConfig"]);
                if (currentLangConfig === null || currentLangConfig === void 0 ? void 0 : currentLangConfig.regions.includes(savedRegion)) {
    ...
    const getLanguageDisplay = ()=>{
        ...
        return "".concat(langConfig.name, " - ").concat(currentRegion.charAt(0).toUpperCase() + currentRegion.slice(1));
    };
...
_s(LanguageProvider, "I2zd/G5VorihrYV2KCAYNadoV34=");
_c = LanguageProvider;
...
function SearchModal(param) {
    ...
    const allResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchModal.useMemo[allResults]": ()=>{
            if (!searchData) return [];
            const flattened = [];
            searchData.sortedSections.forEach({
                "SearchModal.useMemo[allResults]": (section)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchModal.useEffect": ()=>{
                ...
                "SearchModal.useEffect.handleKeyDown": (e)=>{
                    ...
                    switch(e.key){
                        case 'ArrowDown':
                            e.preventDefault();
                            setSelectedIndex({
                                "SearchModal.useEffect.handleKeyDown": (prev)=>prev < allResults.length - 1 ? prev + 1 : 0
                            }["SearchModal.useEffect.handleKeyDown"]);
                            break;
                        case 'ArrowUp':
                            e.preventDefault();
                            setSelectedIndex({
                                "SearchModal.useEffect.handleKeyDown": (prev)=>prev > 0 ? prev - 1 : allResults.length - 1
                            }["SearchModal.useEffect.handleKeyDown"]);
                            break;
                        case 'Enter':
                            e.preventDefault();
            ...
            return ({
                "SearchModal.useEffect": ()=>document.removeEventListener('keydown', handleKeyDown)
            })["SearchModal.useEffect"];
        }
    }["SearchModal.useEffect"], [
        isOpen,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchModal.useEffect": ()=>{
            ...
            const searchTimeout = setTimeout({
                "SearchModal.useEffect.searchTimeout": async ()=>{
                    setIsSearching(true);
                    try {
                        ...
                        if (data.results) {
                            const results = data.results.map({
                                "SearchModal.useEffect.searchTimeout.results": (result)=>({
                                        title: result.title,
                                        path: "/docs".concat(result.href),
                            ...
                            }["SearchModal.useEffect.searchTimeout.results"]);
                            const sectionResults = {};
                            if (data.sectionResults) {
                                Object.keys(data.sectionResults).forEach({
                                    "SearchModal.useEffect.searchTimeout": (section)=>{
                                        sectionResults[section] = data.sectionResults[section].map({
                                            "SearchModal.useEffect.searchTimeout": (result)=>({
                                                    title: result.title,
                                                    path: "/docs".concat(result.href),
                                                    section: result.section,
                                                    level: 1,
                                        ...
                                        }["SearchModal.useEffect.searchTimeout"]);
                                    }
                                }["SearchModal.useEffect.searchTimeout"]);
                            }
                            setSearchData({
            ...
            }["SearchModal.useEffect.searchTimeout"], 300); // Debounce search
            return ({
                "SearchModal.useEffect": ()=>clearTimeout(searchTimeout)
            })["SearchModal.useEffect"];
        }
    }["SearchModal.useEffect"], [
        query,
                        ...
                        query && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                isSearching ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 213,
                                    columnNumber: 17
                                }, this) : searchData && allResults.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: searchData.sortedSections.map((sectionTitle, sectionIndex)=>{
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "".concat(sectionIndex > 0 ? 'mt-6' : ''),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: sectionResults.map((result, index)=>{
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            className: "w-full px-4 py-3 text-left hover:bg-gray-700 transition-colors ".concat(globalIndex === selectedIndex ? 'bg-blue-600' : ''),
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            result.content && result.matchType !== 'title' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        }, "".concat(result.path, "-").concat(index), false, {
                                                            fileName: "[project]/src/components/SearchModal.tsx",
                                                            lineNumber: 241,
                                                            columnNumber: 31
                                                        }, this);
...
_s(SearchModal, "Q/aMY502rfjp7kXMBCr4RoMOC3M=", false, function() {
    return [
...
"[project]/src/components/SearchProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SearchProvider(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchProvider.useEffect": ()=>{
                ...
                "SearchProvider.useEffect.handleKeyDown": (e)=>{
                    ...
                    if ((e.metaKey || e.ctrlKey) && e.key === 'k') {
                        ...
                        if (!pathname.startsWith('/test')) {
                            e.preventDefault();
                            setIsOpen({
                                "SearchProvider.useEffect.handleKeyDown": (prev)=>!prev
            ...
            document.addEventListener('keydown', handleKeyDown);
            return ({
                "SearchProvider.useEffect": ()=>document.removeEventListener('keydown', handleKeyDown)
            })["SearchProvider.useEffect"];
        }
    }["SearchProvider.useEffect"], [
        pathname
...
_s(SearchProvider, "/tbCOIG4/tEDYdI/7qOjOswFa8E=", false, function() {
    return [
...
//# sourceMappingURL=_191f0992._.js.map