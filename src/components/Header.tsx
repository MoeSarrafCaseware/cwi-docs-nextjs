          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={dropdownRef}>
              <button 
                ...
                className="inline-flex items-center gap-1 rounded-full bg-gray-800/70 border border-gray-700 px-2.5 py-1 text-xs text-gray-200 hover:bg-gray-800"
              >
                {getLanguageDisplay()}
                      ...
                      <div key={lang.code}>
                        ...
                        {lang.regions.map((region) => (
                          <button
                            ...
                            className={`w-full text-left px-6 py-2 text-sm hover:bg-gray-700 transition-colors ${
